...
import { Search, Grid3X3, MessageSquare, Volume2, X } from 'lucide-react';
...
const Home: React.FC = () => {
  ...
  // Example pictograms for demonstration
  const examplePictograms = useMemo(() => [
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // For now, filter example pictograms
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h1 className={`text-3xl font-bold text-gray-900 dark:text-white mb-2 ${getFontSize()}`}>
          🎉 TD Snap Web - Hot Reload Funcionando!
        </h1>
      ...
      <div className="max-w-2xl mx-auto">
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-3 pl-12 pr-20 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent ${getFontSize()}`}
          />
